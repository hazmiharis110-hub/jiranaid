            ...
            return (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-xl text-xs whitespace-nowrap transition-all duration-150 border-2 border-black shrink-0 cursor-pointer ${
                  isSelected
                    ? 'bg-[#fecd0e] text-black font-black shadow-[1px_1px_0px_#000] translate-x-0.5 translate-y-0.5'
                    : 'bg-white text-black font-bold shadow-[2px_2px_0px_#000] hover:bg-[#fee26d] hover:shadow-[3.5px_3.5px_0px_#000] hover:-translate-x-0.5 hover:-translate-y-0.5 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none'
                }`}
              >
                {cat}
              </button>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t-2 border-black">
        ...
        <div className="flex items-center gap-3">
          {typeof totalCount === 'number' && (
            <span className="text-xs font-black text-black px-2.5 py-1 rounded-lg border border-black bg-[#fdfae8] shadow-[1px_1px_0px_#000]">
          ...
          {hasActiveFilters && (
            <button
              ...
              className="inline-flex items-center gap-1 px-3 py-1.5 rounded-xl text-xs font-black bg-white text-black border-2 border-black shadow-[2px_2px_0px_#000] hover:bg-[#fee26d] hover:shadow-[3px_3px_0px_#000] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all cursor-pointer"
            >
