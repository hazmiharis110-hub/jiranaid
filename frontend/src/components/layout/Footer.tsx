      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm font-bold">
              ...
              <li>
                <Link to="/items/create" className="text-black font-black hover:bg-[#fee26d] px-1 py-0.5 rounded border border-transparent hover:border-black transition-all inline-block">
                  + List an Appliance
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t-2 border-black mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-bold text-[#555]">
          ...
          <div className="flex items-center gap-3">
            <span className="px-2 py-0.5 rounded bg-[#fdfae8] border border-black text-black font-mono text-[11px]">Taman Puchong Prima (47150)</span>
            <span>•</span>
            <span className="px-2 py-0.5 rounded bg-[#fdfae8] border border-black text-black font-mono text-[11px]">Subang Jaya</span>
          </div>
        </div>
      </div>
    </footer>
